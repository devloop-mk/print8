...
export const adminStrings = {
  ...
  ordering: {
    ...
    productsHelp:
      'Редоследот важи за листи на производи (категории, прилагодување, типови). Штиклирајте „На сајтот“ за да ги покажете или скриете производи. Пребарајте и поставете прв, или влечете редови. Потоа Зачувај.',
    merchDesignsHelp:
    ...
    visibleOnSite: 'На сајтот',
    productHidden: 'Производот е скриен од продавницата.',
    productShown: 'Производот е повторно видлив на продавницата.',
    visibilitySaveError: 'Неуспешно зачувување на видливоста.',
  },
  content: 'Содржина',
  messages: 'Пораки',
  newsletter: {
