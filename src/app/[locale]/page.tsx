    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-10 flex items-end justify-between">
          <h2 className="text-2xl font-bold text-ink-900">{t("featuredServices")}</h2>
      ...
      <section className="bg-ink-50 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="mb-10 text-2xl font-bold text-ink-900">{t("whyUs")}</h2>
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <Card>
              ...
              <p className="mt-2 text-sm text-ink-500">{t("whyDeliveryDesc")}</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-10 flex items-end justify-between">
          <h2 className="text-2xl font-bold text-ink-900">{t("featuredDesigns")}</h2>
          <Link href="/designs" className="text-sm font-medium text-brand-600 hover:text-brand-700">
            {t("viewAll")} →
          </Link>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {featuredDesigns.map((design) => (
            <Link key={design.id} href={`/designs/create?template=${design.id}`}>
      ...
      <section className="bg-ink-50 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 flex items-end justify-between">
            <h2 className="text-2xl font-bold text-ink-900">{t("featuredProducts")}</h2>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {featuredProducts.map((product) => (
              <Link key={product.id} href={`/products/customize/${product.type}?id=${product.id}`}>
                <Card className="overflow-hidden p-0">
